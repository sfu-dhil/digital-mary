...
class CivilizationTest extends ControllerBaseCase {
    ...
    public function testAnonTypeahead() {
        $this->client->request('GET', '/civilization/typeahead?q=civilization');
    ...
    public function testAnonSearch() : void {
        ...
        $this->client->getContainer()->set(CivilizationRepository::class, $repo);
    ...
    public function testAdminEdit() {
        ...
        'civilization[name]' => 'Updated Name',
            'civilization[label]' => 'Updated Label',
            'civilization[description]' => 'Updated Description',
                    ]);
    ...
    public function testAdminNew() {
        ...
        'civilization[name]' => 'New Name',
            'civilization[label]' => 'New Label',
            'civilization[description]' => 'New Description',
                    ]);
