...
class TechniqueTest extends ControllerTestCase {
    ...
    public function testAnonTypeahead() : void {
        $this->client->request('GET', '/technique/typeahead?q=' . self::TYPEAHEAD_QUERY);
    ...
    public function testAdminDelete() : void {
        $repo = self::getContainer()->get(TechniqueRepository::class);
