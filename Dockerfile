...
FROM dm-webpack AS dm-prod-assets
...
COPY --chown=www-data:www-data --chmod=775 --from=dm-prod-assets /app/js/dist /var/www/html/public/js/dist
COPY --chown=www-data:www-data --chmod=775 --from=dm-prod-assets /app/css /var/www/html/public/css
COPY --chown=www-data:www-data --chmod=775 --from=dm-prod-assets /app/node_modules /var/www/html/public/node_modules
